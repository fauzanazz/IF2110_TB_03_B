...
main_program: $(OBJ_MESINKAR) $(OBJ_MESINKATA) $(OBJ_MESINKARFILE) $(OBJ_STRINGFUNC) $(OBJ_LISTDIN) $(OBJ_PRIOQUEUE) $(OBJ_DATETIME) $(OBJ_TIME) $(OBJ_MAIN) $(OBJ_PCOLOR) $(OBJ_MATRIXPROFIL) $(OBJ_PENGGUNA) $(OBJ_PROFIL) $(OBJ_GRAF) $(OBJ_LISTVERTEX) $(OBJ_TEMAN) $(OBJ_UTAS) $(OBJ_TREE) $(OBJ_DATABASE) $(OBJ_MUAT) $(OBJ_SIMPAN) 
	$(CC) $(CFLAGS) -o $@ $^
